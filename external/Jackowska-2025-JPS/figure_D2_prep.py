...
the target of maximising the areal 1C-discharge capacity.
...
param.update(
    {
        ...
        "Optimised nominal capacity [A.h]": optim_Q,
    },
    check_already_exists=False,
)
with open(os.path.join(folder, "design_results", "parameters_after_D2p.pickle"), 'wb') as param_file:
